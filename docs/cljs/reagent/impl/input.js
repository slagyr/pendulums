...
var G__7910 = shadow_root.activeElement;
active_element = G__7910;
continue;
} else {
...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__7911){
var map__7912 = p__7911;
var map__7912__$1 = cljs.core.__destructure_map.call(null,map__7912);
var on_write = cljs.core.get.call(null,map__7912__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
if(cljs.core.truth_((function (){var or__5142__auto__ = (!((((node === reagent.impl.input.get_true_active_element.call(null))) && (((reagent.impl.input.has_selection_api_QMARK_.call(null,node.type)) && (((typeof rendered_value === 'string') && (typeof dom_value === 'string'))))))));
if(or__5142__auto__){
...
var _STAR_force_set_dom_value_STAR__orig_val__7913 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__7914 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__7914);

try{return reagent.impl.input.input_component_set_value.call(null,component);
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__7913);
}}));
} else {
...
(jsprops.onChange = (function (p1__7915_SHARP_){
return reagent.impl.input.input_handle_change.call(null,this$,on_change,p1__7915_SHARP_);
}));
